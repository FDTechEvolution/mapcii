        ...
        <div class="col-md-4 g-mb-10">
            <div class="input-group-btn">
                <select name="orderby" class="custom-select g-bg-white u-select-v1 w-100 g-brd-gray-light-v3 g-color-main g-color-primary--hover" required id="orderby"
                    ...
                    <option class="g-brd-none g-color-main g-color-white--hover g-color-white--active g-bg-primary--hover g-bg-primary--active" value="price_desc">เรียงตามราคาจากมากไปน้อย</option>
                    <option class="g-brd-none g-color-main g-color-white--hover g-color-white--active g-bg-primary--hover g-bg-primary--active" value="price_asc">เรียงตามราคาจากน้อยไปมาก</option>
