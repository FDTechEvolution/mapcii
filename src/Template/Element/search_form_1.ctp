...
<div class="g-bg-black-opacity-0_7 g-pa-30">
        ...
        <div class="col-md-2 g-mb-30">
            ...
            <div class="input-group-btn">
                <select class="js-custom-select g-bg-white u-select-v1 w-100 g-brd-gray-light-v3 g-color-main g-color-primary--hover g-py-12" required
                    ...
                    <option class="g-brd-none g-color-main g-color-white--hover g-color-white--active g-bg-primary--hover g-bg-primary--active" value="RENT">เช่า</option>
                    <option class="g-brd-none g-color-main g-color-white--hover g-color-white--active g-bg-primary--hover g-bg-primary--active" value="SALES">ขาย</option>
