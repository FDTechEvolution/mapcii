                ...
                <article class="row no-gutters g-mb-15">
                    ...
                    <div class="col-lg-7">
                        <div class="g-brd-around g-brd-top-none g-brd-gray-light-v3 g-bg-white">
                            ...
                            <div class="g-pa-10">
                                <strong class="g-color-primary--hover"><?=$this->Html->link($asset['name'],['controller'=>'assets','action'=>'view',$asset['id']],[])?></strong>
                        ...
                        <a class="btn btn-block g-brd-top-none g-brd-gray-light-v3 g-brd-primary--hover g-color-main g-color-white--hover g-bg-secondary g-bg-primary--hover g-font-weight-600 rounded-0 g-px-10 g-py-10" href="<?=SITE_URL?>assets/view?id=<?=$asset['id']?>">
                            ดูรายละเอียด
