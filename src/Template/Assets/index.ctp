                ...
                <article class="row no-gutters g-mb-15">
                    ...
                    <div class="col-lg-7">
                        <div class="g-brd-around g-brd-top-none g-brd-gray-light-v3 g-bg-white">
                            ...
                            <div class="g-pa-10">
                                <strong class="g-color-primary--hover"><?=$this->Html->link($asset['name'],['controller'=>'property','action'=>'view',$asset['id']],[])?></strong>
                            ...
                            <ul class="d-flex list-inline align-items-center g-brd-top g-brd-gray-light-v3 mb-0">
                                ...
                                <li class="list-inline-item col-2 g-px-0 mr-0">
                                    <a class="d-block g-brd-x g-brd-gray-light-v3 g-color-text g-color-primary--hover g-font-weight-500 g-font-size-17 text-center g-text-underline--none--hover g-py-7" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add to Compare">
                        ...
                        <a class="btn btn-block g-brd-top-none g-brd-gray-light-v3 g-brd-primary--hover g-color-main g-color-white--hover g-bg-secondary g-bg-primary--hover g-font-weight-600 rounded-0 g-px-10 g-py-10" href="<?=SITE_URL?>property/view?id=<?=$asset['id']?>">
                            ดูรายละเอียด
