<div class="g-bg-cover g-bg-pos-top-center g-bg-img-hero" style="background-image: url(<?= COVER_TITLE_IMAGE ?>);">
    <div class="g-pos-rel g-z-index-1">
        ...
        <div class="container-fluid g-py-50">
            ...
            <h1 class="h2 mb-0"><?= $this->request->getQuery('type') ?></h1>
        </div>
...
<script>
    var asset_type_id = '<?=$asset_type_id?>';
    $(document).ready(function () {
        $.get(apiurl + 'api-assets/avaliable-asset?type='+asset_type_id).done(function (res) {
            res = JSON.parse(res);
