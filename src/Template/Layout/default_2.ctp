...
<html lang="en">
    <head>
        ...
        <?= $this->Html->css('/assets/vendor/hamburgers/hamburgers.min.cs')?>
    ...
    <body>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 g-hidden-md-down">
                                ...
                                <ul class="list-inline d-flex align-items-center ml-3 mb-0">
                                    ...
                                    <li class="list-inline-item g-mx-3">
                                        <a class="u-icon-v2 u-icon-size--xs g-brd-gray-light-v2 g-brd-primary-dark-v1--hover g-color-gray-dark-v5 g-color-white--hover g-bg-primary-dark-v1--hover" href="#">
                            ...
                            <div class="col-10 col-md-8 col-lg-6 ml-auto">
                                ...
                                <ul class="list-inline float-right mb-0">
                                    ...
                                    <li class="list-inline-item g-hidden-xs-down g-mx-2">
                                        <a class="u-link-v5 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-font-size-12 g-pa-10" href="page-contacts-1.html">
                                    ...
                                    <li class="list-inline-item g-hidden-xs-down g-mx-2">
                                        <a class="u-link-v5 g-color-gray-dark-v5 g-color-primary--hover g-font-weight-500 g-font-size-12 g-pa-10" href="#">
                                            <i class="align-middle g-font-size-11 mr-1 icon-finance-206 u-line-icon-pro"></i>
                                            Live Chat
                                        </a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="u-link-v5 g-color-main g-color-white--hover g-bg-secondary g-bg-primary-dark-v1--hover g-font-weight-500 g-px-15 g-py-10" href="page-register-1.html">Register</a>
                                    </li>
                                    <li class="list-inline-item">
                                        <a class="u-link-v5 g-color-white g-bg-primary g-bg-primary-dark-v1--hover g-font-weight-500 g-px-15 g-py-10" href="page-login-1.html">Login</a>
                                    </li>
                                </ul>
                                <!-- End List -->
                            </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="navBar" class="collapse navbar-collapse align-items-center order-lg-last g-brd-top g-brd-none--lg g-brd-primary-dark-v1">
                            <ul class="navbar-nav g-py-30 g-py-0--lg">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link g-color-white g-brd-right--lg g-brd-primary-dark-v1 g-bg-primary-dark-v1--hover g-font-weight-600 g-font-size-default g-px-17 g-px-23--xl g-py-15" href="../../index.html">Main</a>
                                </li>
                            </ul>
                        </div>
                        <!-- End Navigation -->
        ...
        <main>
                                ...
                                <div class="col-sm-6 col-lg-2 g-mb-30">
                                    ...
                                    <div class="btn-group justified-content">
                                        <label class="u-check">
                                            ...
                                            <span class="btn btn-md btn-block u-btn-outline-white g-brd-gray-light-v3 g-brd-primary--checked g-color-main g-color-primary--checked g-font-size-default rounded-0 g-py-13">Buy</span>
                                        </label>
                                        <label class="u-check">
                                            <input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" name="radGroupBtn1_1" type="radio">
                                            <span class="btn btn-md btn-block u-btn-outline-white g-brd-gray-light-v3 g-brd-primary--checked g-color-main g-color-primary--checked g-font-size-default rounded-0 g-py-13">Rent</span>
                                        </label>
                                    </div>
                                    <!-- End Radio Group -->
                                </div>
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    ...
                                    <img class="img-fluid" src="assets/img-temp/900x400/img1.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--01"
                                       data-src="assets/img-temp/900x400/img2.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                ...
                                <div class="js-slide g-pos-rel">
                                    ...
                                    <img class="img-fluid" src="assets/img-temp/900x400/img3.jpg" alt="Image Description">
                                </div>
                            </div>
                            <!-- Products - Carousel Image -->
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <!-- Products - Address -->
                                <div class="g-pa-25">
                                    <h3 class="g-font-weight-600 g-font-size-16">Flat 60, Ross Green, South Lilyberg, Q7M 8ZV</h3>
                                ...
                                <ul class="d-flex list-inline align-items-center g-brd-top g-brd-gray-light-v3 mb-0">
                                    <li class="list-inline-item col-8 g-font-weight-600 g-font-size-17 text-center g-px-0 g-py-13 mr-0">
                                        $14,999<span class="g-font-size-13">/mo</span>
                                    </li>
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       ...
                                       data-src="assets/img-temp/600x450/img4.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img4.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--03"
                                       data-src="assets/img-temp/600x450/img8.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img8.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--03"
                                       data-src="assets/img-temp/600x450/img9.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img9.jpg" alt="Image Description">
                                </div>
                            </div>
                            <!-- Products - Carousel Image -->
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <!-- Products - Address -->
                                <div class="g-pa-25">
                                    <h3 class="g-font-weight-600 g-font-size-16">470 Lucy Forks, Patriciafurt, YC7B</h3>
                                    <p class="g-font-size-13 mb-4">London, England</p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-text g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">American Property</a></p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-text g-font-weight-400">12 days ago</a></p>
                                </div>
                                <!-- End Products - Address -->
                                ...
                                <ul class="d-flex list-inline align-items-center g-brd-top g-brd-gray-light-v3 mb-0">
                                    <li class="list-inline-item col-8 g-font-weight-600 g-font-size-17 text-center g-px-0 g-py-13 mr-0">
                                        $7,000<span class="g-font-size-13">/mo</span>
                                    </li>
                                    <li class="list-inline-item col-2 g-px-0 mr-0">
                                        <a class="d-block g-brd-x g-brd-gray-light-v3 g-color-text g-color-primary--hover g-font-weight-500 g-font-size-17 text-center g-text-underline--none--hover g-py-13" href="javascript:void(0);"
                                           data-toggle="tooltip"
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       ...
                                       data-src="assets/img-temp/600x450/img5.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img5.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--04"
                                       data-src="assets/img-temp/600x450/img6.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img6.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--04"
                                       data-src="assets/img-temp/600x450/img7.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img7.jpg" alt="Image Description">
                                </div>
                            </div>
                            <!-- Products - Carousel Image -->
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <!-- Products - Address -->
                                <div class="g-pa-25">
                                    <h3 class="g-font-weight-600 g-font-size-16">06 Bell Views, Andyshire, BN2L 9WC</h3>
                                    <p class="g-font-size-13 mb-4">Edinburgh, Scotland</p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-text g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">Real Estate State</a></p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-text g-font-weight-400">12 days ago</a></p>
                                </div>
                                <!-- End Products - Address -->
                                ...
                                <ul class="d-flex list-inline align-items-center g-brd-top g-brd-gray-light-v3 mb-0">
                                    <li class="list-inline-item col-8 g-font-weight-600 g-font-size-17 text-center g-px-0 g-py-13 mr-0">
                                        $1,200<span class="g-font-size-13">/mo</span>
                                    </li>
                                    <li class="list-inline-item col-2 g-px-0 mr-0">
                                        <a class="d-block g-brd-x g-brd-gray-light-v3 g-color-text g-color-primary--hover g-font-weight-500 g-font-size-17 text-center g-text-underline--none--hover g-py-13" href="javascript:void(0);"
                                           data-toggle="tooltip"
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       ...
                                       data-src="assets/img-temp/600x450/img11.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img11.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--05"
                                       data-src="assets/img-temp/600x450/img10.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img10.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--05"
                                       data-src="assets/img-temp/600x450/img12.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img12.jpg" alt="Image Description">
                                </div>
                            </div>
                            <!-- Products - Carousel Image -->
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <!-- Products - Address -->
                                <div class="g-pa-25">
                                    <h3 class="g-font-weight-600 g-font-size-16">4 Allen Ramp, New Dean, T01 2WA</h3>
                                    <p class="g-font-size-13 mb-4">London, England</p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-text g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">American Property</a></p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-text g-font-weight-400">12 days ago</a></p>
                                </div>
                                ...
                                <ul class="d-flex list-inline align-items-center g-brd-top g-brd-gray-light-v3 mb-0">
                                    <li class="list-inline-item col-8 g-font-weight-600 g-font-size-17 text-center g-px-0 g-py-13 mr-0">
                                        $2,350<span class="g-font-size-13">/mo</span>
                                    </li>
                                    <li class="list-inline-item col-2 g-px-0 mr-0">
                                        <a class="d-block g-brd-x g-brd-gray-light-v3 g-color-text g-color-primary--hover g-font-weight-500 g-font-size-17 text-center g-text-underline--none--hover g-py-13" href="javascript:void(0);"
                                           data-toggle="tooltip"
            ...
            <!-- About Us -->
            <div class="g-bg-cover g-bg-pos-top-center g-bg-img-hero g-pt-100 g-pb-70" style="background-image: url(assets/img/bg/map-sketch.jpg);">
                <div class="g-pos-rel g-z-index-1">
                    <!-- Heading -->
                    <div class="g-max-width-750 text-center mx-auto g-mb-100">
                        <h2 class="mb-4">Our goal - is your peacefulness and confidence when choosing a property</h2>
                        <p class="g-font-size-16 g-line-height-2">Unify Real Estate's inspired range of residential communities offers comfortable and family-friendly living. The communities within Unify Real Estate meet all the needs of their residents with amenities like schools, shopping malls, nurseries and healthcare. Together, these communities are part of our vision to create a sprawling haven in which growing families can live, work and play.</p>
                    </div>
                    <!-- End Heading -->
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-3 g-mb-30">
                                <!-- Product - Services -->
                                <div class="text-center">
                                    <span class="u-icon-v3 u-icon-size--xl g-color-white g-bg-primary rounded-circle mb-4">
                                        <i class="icon-real-estate-001 u-line-icon-pro"></i>
                                    </span>

                                    <h3 class="h5 text-uppercase">We Find the Best</h3>
                                    <p>options only according to your preferences</p>
                                </div>
                            ...
                            <div class="col-md-3 g-mb-30">
                                ...
                                <div class="text-center">
                                    <span class="u-icon-v3 u-icon-size--xl g-color-white g-bg-primary rounded-circle mb-4">
                                        <i class="icon-real-estate-013 u-line-icon-pro"></i>
                                    </span>

                                    <h3 class="h5 text-uppercase">We Check</h3>
                                    <p>all legal issues when concluding a transaction</p>
                                </div>
                                <!-- End Product - Services -->
                            </div>
                            ...
                            <div class="col-md-3 g-mb-30">
                                ...
                                <div class="text-center">
                                    <span class="u-icon-v3 u-icon-size--xl g-color-white g-bg-primary rounded-circle mb-4">
                                        <i class="icon-christmas-037 u-line-icon-pro"></i>
                                    </span>

                                    <h3 class="h5 text-uppercase">Bonuses</h3>
                                    <p>pleasant gifts and bonuses to each client</p>
                                </div>
                                <!-- End Product - Services -->
                            </div>
                        </div>
            ...
            <div class="container g-py-100">
                <!-- Heading -->
                <div class="text-center g-mb-50">
                    <span class="u-icon-v1 u-icon-size--xl g-color-primary"><i class="icon-real-estate-016 u-line-icon-pro"></i></span>
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       ...
                                       data-src="assets/img-temp/600x450/img1.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--06"
                                       data-src="assets/img-temp/600x450/img2.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img2.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--06"
                                       data-src="assets/img-temp/600x450/img3.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img3.jpg" alt="Image Description">
                                </div>
                            </div>
                            <!-- Products - Carousel Image -->
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <!-- Products - Address -->
                                <div class="g-pa-25">
                                    <h3 class="g-font-weight-600 g-font-size-16">Flat 60, Ross Green, South Lilyberg</h3>
                                    <p class="g-font-size-13 mb-4">Milan, Italy</p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-text g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">Real Estate State</a></p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-text g-font-weight-400">12 days ago</a></p>
                                </div>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       ...
                                       data-src="assets/img-temp/600x450/img15.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img15.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--07"
                                       data-src="assets/img-temp/600x450/img16.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img16.jpg" alt="Image Description">
                                </div>
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--07"
                                       data-src="assets/img-temp/600x450/img17.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                                    </a>
                                    <img class="img-fluid" src="assets/img-temp/600x450/img17.jpg" alt="Image Description">
                                </div>
                            </div>
                            <!-- Products - Carousel Image -->
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--08"
                                       data-src="assets/img-temp/600x450/img3.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--09"
                                       data-src="assets/img-temp/600x450/img2.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="js-carousel"
                                ...
                                <div class="js-slide g-pos-rel">
                                    <a class="js-fancybox d-block u-icon-v3 g-width-30 g-height-30 g-color-main g-bg-primary-opacity-0_6 g-bg-primary--hover g-color-white g-font-size-14 g-pos-abs g-bottom-0 g-right-65" href="javascript:;"
                                       data-fancybox="lightbox-gallery--10"
                                       data-src="assets/img-temp/600x450/img8.jpg"
                                       data-speed="350"
                                       data-caption="Lightbox Gallery">
                                        <i class="icon-size-fullscreen"></i>
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        ...
                        <article>
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <!-- Products - Address -->
                                <div class="g-pa-25">
                                    <h3 class="g-font-weight-600 g-font-size-16">Studio 23, Peter Loop, Chrisfurt</h3>
                                    <p class="g-font-size-13 mb-4">London, England</p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-1">Agency: <a class="g-color-text g-color-primary--hover g-font-weight-400 g-text-underline--none--hover" href="#">American Property</a></p>
                                    <p class="g-color-text g-font-weight-500 g-font-size-13 mb-0">Posted: <span class="g-color-text g-font-weight-400">12 days ago</a></p>
                                </div>
            ...
            <!-- Testimonials -->
            <div class="g-bg-primary g-pos-rel">
                <div class="container">
                    <div class="row justify-content-end align-items-center g-min-height-70vh">
                        <div class="col-lg-5 order-lg-2 align-self-center g-py-70 g-py-0--lg">
                            <!-- Carousel - Text -->
                            <div id="carouselCus1" class="js-carousel"
                                ...
                                <div class="js-slide">
                                    <blockquote class="g-color-white g-font-weight-600 g-font-size-26 mb-0">
                                        <div class="mb-5">
                                            <span class="g-color-white-opacity-0_6 g-font-size-26">"</span>
                                            We have worked with Diane &amp; Jen both buying and selling 3 times over the years and cannot say enough about their dedication, industry savvy and the great team they have supporting them.
                                            <span class="g-color-white-opacity-0_6 g-font-size-26">"</span>
                                        </div>
                                        <h4 class="g-color-white g-font-weight-600 mb-0">Shane &amp; Rob, <span class="g-color-white-opacity-0_6 g-font-size-16">Customer</span></h4>
                                    </blockquote>
                                </div>
                                ...
                                <div class="js-slide">
                                    <blockquote class="g-color-white g-font-weight-600 g-font-size-26 mb-0">
                                        <div class="mb-5">
                                            <span class="g-color-white-opacity-0_6 g-font-size-26">"</span>
                                            You had a great sense of what the market would be willing to pay, and of what we needed to do to present the house well. You can be sure that you’ll be hearing from us when we’re on our way back to Ottawa.
                                            <span class="g-color-white-opacity-0_6 g-font-size-26">"</span>
                                        </div>
                                        <h4 class="g-color-white g-font-weight-600 mb-0">Ian, <span class="g-color-white-opacity-0_6 g-font-size-16">Customer</span></h4>
                                    </blockquote>
                                </div>
                                ...
                                <div class="js-slide">
                                    <blockquote class="g-color-white g-font-weight-600 g-font-size-26 mb-0">
                                        <div class="mb-5">
                                            <span class="g-color-white-opacity-0_6 g-font-size-26">"</span>
                                            Their enthusiasm, knowledge of the neighbourhood and marketing strategy were instrumental in getting a great price (over asking) in less than a week.
                                            <span class="g-color-white-opacity-0_6 g-font-size-26">"</span>
                                        </div>
                                        <h4 class="g-color-white g-font-weight-600 mb-0">Joan, <span class="g-color-white-opacity-0_6 g-font-size-16">Customer</span></h4>
                                    </blockquote>
                                </div>
                            </div>
                            <!-- End Carousel - Text -->
                        ...
                        <div class="col-lg-6 order-lg-1 align-self-center g-pos-abs--lg g-top-0 g-left-0 g-pl-0">
                            <!-- Carousel - Image -->
                            <div id="carouselCus2" class="js-carousel"
                                 data-infinite="true"
                                 data-is-thumbs="true"
                                 data-nav-for="#carouselCus1"
                                 data-arrows-classes="u-arrow-v1 g-pos-abs g-top-0 g-width-40 g-height-40 g-color-white g-color-primary--hover g-bg-primary-dark-v1 g-bg-main--hover"
                                 data-arrow-left-classes="fa fa-angle-left g-right-40 g-brd-right g-brd-white-opacity-0_1"
                                 data-arrow-right-classes="fa fa-angle-right g-right-0">
                                <div class="js-slide g-min-height-70vh g-bg-size-cover g-bg-pos-top-center" data-bg-img-src="assets/img-temp/900x900/img1.jpg"></div>
                                <div class="js-slide g-min-height-70vh g-bg-size-cover g-bg-pos-top-center" data-bg-img-src="assets/img-temp/900x900/img2.jpg"></div>
                                <div class="js-slide g-min-height-70vh g-bg-size-cover g-bg-pos-top-center" data-bg-img-src="assets/img-temp/900x900/img3.jpg"></div>
                            </div>
                            <!-- End Carousel - Image -->
                        </div>
                    </div>
            ...
            <div class="container g-py-100">
                <!-- Heading -->
                <div class="text-center g-mb-50">
                    <span class="u-icon-v1 u-icon-size--xl g-color-primary"><i class="icon-real-estate-013 u-line-icon-pro"></i></span>
                    <h2>New Buildings</h2>
                </div>
                <!-- End Heading -->
                ...
                <div class="row g-mb-40">
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        <!-- Products -->
                        <article>
                            <img class="img-fluid" src="assets/img-temp/600x450/img14.jpg" alt="Image Description">
                                ...
                                <div class="g-pa-25">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">1 rm. <span class="g-color-text g-font-size-10">from</span> 900 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $1,500</span>
                                        </li>
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">2 rm. <span class="g-color-text g-font-size-10">from</span> 1,700 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $2,250</span>
                                        </li>
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">3 rm. <span class="g-color-text g-font-size-10">from</span> 3,000 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $5,000</span>
                                        </li>
                                    </ul>
                                    <!-- End Products - List of Details -->
                                </div>
                    ...
                    <div class="col-sm-6 col-lg-4 g-mb-30">
                        <!-- Products -->
                        <article>
                            <img class="img-fluid" src="assets/img-temp/600x450/img13.jpg" alt="Image Description">
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <div class="g-pa-25">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">1 rm. <span class="g-color-text g-font-size-10">from</span> 900 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $900</span>
                                        </li>
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">2 rm. <span class="g-color-text g-font-size-10">from</span> 1,700 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $1,100</span>
                                        </li>
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">3 rm. <span class="g-color-text g-font-size-10">from</span> 3,000 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $3,299</span>
                                        </li>
                                    </ul>
                                    <!-- End Products - List of Details -->
                                </div>
                            ...
                            <div class="g-brd-x g-brd-gray-light-v3 g-bg-white">
                                ...
                                <div class="g-pa-25">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">1 rm. <span class="g-color-text g-font-size-10">from</span> 900 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $5,550</span>
                                        </li>
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">2 rm. <span class="g-color-text g-font-size-10">from</span> 1,700 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $7,950</span>
                                        </li>
                                        <li class="g-brd-bottom--dashed g-brd-gray-light-v3 pt-1 mb-3">
                                            <span class="g-font-weight-500 g-font-size-12">3 rm. <span class="g-color-text g-font-size-10">from</span> 3,000 sqft:</span>
                                            <span class="float-right g-color-black"><span class="g-color-text g-font-size-10">from</span> $12,000</span>
                                        </li>
                                    </ul>
                                    <!-- End Products - List of Details -->
                                </div>
            ...
            <!-- End New Buildings Products -->

            <!-- Call to Action -->
            <div class="g-bg-primary g-py-100">
                <div class="g-max-width-645 text-center mx-auto">
                    <div class="mb-5">
                        <h2 class="g-color-white g-font-weight-600">Change of a living place - is the first step towards favorable changes</h2>
                    </div>

                    <span class="d-inline-block g-font-weight-600 text-uppercase mr-4">Call Us</span>
                    <a class="btn u-btn-outline-white g-brd-2 g-color-main g-color-primary--hover g-bg-white--hover g-font-weight-600 g-font-size-12 text-uppercase rounded-0 g-px-25 g-py-13 mb-2" href="#">
                        (0161) 347 8854
                    ...
                    <a class="btn u-btn-black g-brd-primary--hover g-color-primary g-color-main--hover g-bg-main g-bg-white--hover g-font-weight-600 g-font-size-12 text-uppercase rounded-0 g-px-25 g-py-13 mb-2" href="page-contacts-1.html">
                        Contact Us
                        <i class="g-pos-rel g-top-minus-1 ml-2 fa fa-angle-right"></i>
                    </a>
                </div>
        ...
        <?= $this->Html->script('/assets/js/helpers/hs.hamburgers.j')?>
